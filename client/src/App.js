    ...
    return (
      <div className="map">
        ...
        <Card className="footer">
          <CardText> Made with <span role="img" aria-label="love">💚</span> by <a href="https://github.com/DhruvDoshi" target="_blank" rel="noopener noreferrer">Dhruv Doshi</a></CardText>
        </Card>
      </div>
    );
  }
